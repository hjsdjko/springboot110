...
public class JuanzengwupinEntity<T> implements Serializable {
	 ...
	 * 设置：捐赠图片
	 */
	public void setJuanzengtupian(String juanzengtupian) {
		this.juanzengtupian = juanzengtupian;
	}
	/**
	 * 获取：捐赠图片
	 */
	public String getJuanzengtupian() {
		return juanzengtupian;
	}
	/**
	 * 设置：姓名
	 */
