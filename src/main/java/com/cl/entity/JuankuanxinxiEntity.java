...
public class JuankuanxinxiEntity<T> implements Serializable {
	 ...
	 * 设置：几届学生
	 */
	public void setJijiexuesheng(String jijiexuesheng) {
		this.jijiexuesheng = jijiexuesheng;
	}
	/**
	 * 获取：几届学生
	 */
	public String getJijiexuesheng() {
		return jijiexuesheng;
	}
	/**
	 * 设置：手机
	 */
	 ...
	 * 设置：捐款金额
	 */
	public void setJuankuanjine(String juankuanjine) {
		this.juankuanjine = juankuanjine;
	}
	/**
	 * 获取：捐款金额
	 */
	public String getJuankuanjine() {
		return juankuanjine;
	}
	/**
	 * 设置：是否支付
